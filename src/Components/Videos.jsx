import { Heading, Text, Stack, Button, VStack } from '@chakra-ui/react'
...
const Videos = () =>{
    ...
    <Stack direction={["column","row"]} h={"100vh"} >
        <VStack w={"full"}>
            <video src={videoSrc} autoPlay controls controlsList="nodownload" style={{width:"100%"}} ></video>
            <VStack alignItems={['flex-start',"flex-start"]} overflowY={"auto"}>
                <Heading>this is a sample video</Heading>
                <Text>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo magni, eveniet adipisci rem doloribus id, quia quaerat cupiditate eaque optio provident ducimus? Voluptas fugit reiciendis ducimus vitae dolorem doloribus.</Text>
            </VStack>
        </VStack>
        <VStack w={["full","xl"]} alignItems={"stretch"} p={"9"} overflowY={"auto"}>
